...
This example shows how to use Llama 3.2, via Ollama, to translate the
`lm()` function’s help into Spanish:
...
There are two ways to define the LLM that `lang` will use during the R
session.
